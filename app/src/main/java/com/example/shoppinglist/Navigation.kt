    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            ModalDrawerSheet {
                ...
                HorizontalDivider()
                NavigationDrawerItem(    icon = { Icon(Screen.Settings.icon, contentDescription = Screen.Settings.title) },
                    ...
                    onClick = {
                        ...
                        navController.navigate(Screen.Settings.route) {
                            // Pop up ke start destination untuk membersihkan back stack
                            // Ini akan membuat tumpukan menjadi [Home, Settings]
                            popUpTo(navController.graph.findStartDestination().id) {
                                saveState = true
                            }
                            // Hindari membuat halaman Settings baru jika sudah ada di atas
                            launchSingleTop = true
                            // Kembalikan state jika ada
                            restoreState = true
                        }
                    }
                )
